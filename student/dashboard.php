    ...
    function renderHomePage() {
        return '<div class="home-stats">' +
            '<div class="stat-card">' +
                ...
                '<div class="stat-value" style="color: #FF6B6B;">' + APP.stats.diem_tb + '</div>' +
                '<div class="stat-label">Điểm trung bình</div>' +
            '</div>' +
            '<div class="stat-card">' +
                '<div class="stat-icon" style="background: rgba(78, 205, 196, 0.15);">✅</div>' +
                '<div class="stat-value" style="color: #4ECDC4;">' + APP.stats.so_bai + '</div>' +
        ...
        '<div class="home-actions">' +
            '<div class="action-card" onclick="navigateTo(\'exams\')">' +
                '<div class="action-icon" style="background: linear-gradient(135deg, #FF6B6B 0%, #FF8E53 100%);">📝</div>' +
            ...
            '<div class="action-card" onclick="navigateTo(\'documents\')">' +
                '<div class="action-icon" style="background: linear-gradient(135deg, #4ECDC4 0%, #44A8B3 100%);">📚</div>' +
                '<div class="action-info">' +
                    '<h3>Xem tài liệu</h3>' +
            ...
            html += '<div class="' + cardClass + '" style="position: relative; ' + (canClick ? 'cursor: pointer;' : 'opacity: 0.9;') + '" ' + (canClick ? 'onclick="startExam(' + exam.id + ')"' : '') + '>' +
                ...
                '<div class="item-header" style="margin-top: 8px;">' +
                    ...
                    '<div>' +
                        ...
                        '<div class="item-subtitle">' + escapeHtml(exam.ten_mon) + (isChinhThuc ? ' • <span style="color: #D97706; font-weight: 700;">Thi chính thức</span>' : ' • <span style="color: #667eea;">Luyện tập</span>') + '</div>' +
                    '</div>' +
                '</div>' +
                '<div class="item-meta">' +
